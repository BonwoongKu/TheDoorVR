...
{
    public abstract class InteractObjectBasicAbstract : MonoBehaviour
    {
        ...
        public bool IsEqual(InteractObjectBasicAbstract _target) { if (_target == null)    return false; else return (m_iUniqueID == _target.UID); }
